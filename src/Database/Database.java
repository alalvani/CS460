...
public class Database
{
  ...
  public void connect()
  {
    ...
    try
    {
      ...
      connection = DriverManager.getConnection(
          "jdbc:mysql://192.254.189.198/dgomez_airexpress", "dgomez_team6",
          "1qa2ws3ed");
    }
  ...
  public void addUser(String firstName, String lastName,
      String email, String phone, Date dob, String address, int guest,
      String credit, String seatingPref, String passwd)
  {
    //calculate current date and print it to formatted string
    Calendar cal = Calendar.getInstance();
    String date=new SimpleDateFormat("yyyy-MM-dd").format(cal.getTime());
    
    
    
    String entry = "INSERT INTO Users (first_name, email, last_name,phone, "
        + "date_of_birth,address, created,guest,credit,seating_preference,password)"
        + " VALUES ('"
        + firstName
        + "','"
        + email
    ...
    //TODO add user as first passenger
  ...
  public void notification(String type, int flightID) throws SQLException
  {
    ...
    String query = "" + " SELECT method_of_notification FROM Passengers "
    ...
    while (resultSet.next())
    {
      ...
      /*
       * TODO: add parsing for phone numbers vs email, send messages
  ...
  /**
   * Create a new flight to be added to the schedule. This function must be
   * called when a connection is already open.
   * 
   * @param flight_id
   ...
   * @throws SQLException
   */
  public void enterNewFlight(int flight_id, int plane_id, String flight_number,
      String departureAirport, String arrivalAirport, String departureTime,
      String arrivalTime, int freeSeats, String departureGate,
      String arrivalGate, String status, double currentPrice)
      throws SQLException
  {

    String instructions = "INSERT INTO Flights " + "VALUES (" + flight_id + ","
        + plane_id + ",'" + flight_number + "','" + departureAirport + "','"
        + arrivalAirport + "','" + departureTime + "','" + arrivalTime + "',"
        + freeSeats + ",'" + departureGate + "','" + arrivalGate + "','"
        + status + "'," + currentPrice + ")";
  ...
  public void book(int flight_id, int passenger_id, String seat)
      throws SQLException
  {

    // concatinate the flight number on to the flight_list of the itinerary
    // associated with
    // a given passenger
